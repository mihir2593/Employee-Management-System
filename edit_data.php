  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    class Demo{
        ...
        <div class = "col-10  mb-3 " >
             Enter Employee ID : <input class="form-control" type="text" value="<?php echo $empid ?>" name="empid">
        </div>  
            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        // $selected = in_array($row['id'], $dep) ? 'selected' : '';
        ...
        <div class = "col-10  mb-3 " >
            Enter your Name : <input class="form-control" type="text" value="<?php echo $name ?>" name="name">
        </div>
        <div class = "col-10  mb-3 " >
            Enter your Designation : <input class="form-control" type="text" value="<?php echo $designation ?>"name="designation">
        </div>
        <div class = "col-10  mb-3 " >
            Enter your Salary : <input class="form-control" type="number" value="<?php echo $salary ?>"name="salary">
        </div>
        <div class = "col-10  mb-3 " >
            Upload Your Image : 
            <div class="custom-file">
            <input class="custom-file-input" type="file"  value="<?php echo $image ?>" name="image">
            <label class="custom-file-label" for="image">Choose file</label>
            </div>
        </div>
        <div class = "col-10  mb-3 " >
            <button class="btn btn-primary" value="<?php echo $id ?>" name = "update" >Update data </button>
            </div>
            </form>
            </div>
            </div>
